...
export class BrAutocompleteComponent extends BaseValueAccessor<string> implements OnInit, OnChanges, OnDestroy {
  ...
  private resolveConfig(): BrAutocompleteConfig {
    const source: BrAutocompleteConfig = this.config
      ? { ...this.config }
      : {
        label: '',
        value: '',
