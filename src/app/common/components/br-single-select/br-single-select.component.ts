...
export class BrSingleSelectComponent extends BaseValueAccessor<any> implements OnInit, OnChanges, OnDestroy {
  ...
  private resolveConfig(): BrSingleSelectConfig {
    const source: BrSingleSelectConfig = this.config
      ? { ...this.config }
      : {
        label: '',
        value: '',
