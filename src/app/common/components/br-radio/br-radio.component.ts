...
export class BrRadioComponent extends BaseValueAccessor<any> implements OnInit, OnChanges, OnDestroy {
  ...
  private resolveConfig(): BrRadioConfig {
    const source: BrRadioConfig = this.config
      ? { ...this.config }
      : {
        label: '',
        value: '',
