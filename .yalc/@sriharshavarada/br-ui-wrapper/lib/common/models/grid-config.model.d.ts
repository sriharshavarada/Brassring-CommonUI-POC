...
export type BrGridActionSource = 'toolbar-primary' | 'toolbar-primary-menu' | 'selection-action' | 'context-menu' | 'sort-apply' | 'sort-clear' | 'filter-apply' | 'filter-clear' | 'columns-save' | 'columns-cancel' | 'refresh' | 'search-toggle' | 'view-mode-toggle' | 'page-change' | 'page-size-change' | 'selection-change';
